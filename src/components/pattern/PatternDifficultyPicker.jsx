...
import { PATTERN_PAD_COUNT_BY_DIFFICULTY } from '@/lib/pattern/patternDifficulty';
import { cn } from '@/lib/utils';

/**
 * @param {object} props
 * @param {string} props.currentDifficulty
 */
export default function PatternDifficultyPicker({ currentDifficulty }) {
